...
describe('Comments', () => {
  ...
  it('should render correctly without comments', async () => {
    ...
    const { getByPlaceholderText } = render(<CommentsView item={CommentsModel.create({})} />);
  ...
  it('should add a comment', async () => {
    ...
    const { getByText, getByLabelText, getByTestId, getByPlaceholderText } = render(<CommentsView item={CommentsModel.create({})} />);
  ...
  it('should correctly resolve/unresolve a comment', async () => {
    ...
    const { getByTestId, getByText } = render(<CommentsView item={CommentsModel.create({})} />);
